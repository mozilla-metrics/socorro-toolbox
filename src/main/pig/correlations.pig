...
ss = FOREACH modules GENERATE filename,module_version,debug_file,debug_id,product,version,os_name;
/* Ask pig mailing list why this works but DISTINCT ss; doesn't */
grpd = GROUP ss BY (filename,debug_file,debug_id,module_version,product,version,os_name);
